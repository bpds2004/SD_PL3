...
class GestorPrincipal
{
    ...
    static void Main()
    {
        ...
        {
            FileName = @"C:\Users\35196\source\repos\SD_PL3\MonitorizacaoOceanica\MonitorizacaoOceanica\Servidor 2.0\bin\Debug\net8.0\Servidor 2.0.exe",
            UseShellExecute = true
        });
        Process.Start(new ProcessStartInfo
        {
            FileName = @"C:\Users\35196\source\repos\SD_PL3\MonitorizacaoOceanica\MonitorizacaoOceanica\Servidor20.UI\bin\Debug\net9.0\Servidor20.UI.exe",
            UseShellExecute = true
        });
        ...
        Process.Start(new ProcessStartInfo
        {
            FileName = @"C:\Users\35196\source\repos\SD_PL3\MonitorizacaoOceanica\MonitorizacaoOceanica\PreprocessingService\bin\Debug\net8.0\PreprocessingService.exe",
            UseShellExecute = true
        });
        ...
        Process.Start(new ProcessStartInfo
        {
            FileName = @"C:\Users\35196\source\repos\SD_PL3\MonitorizacaoOceanica\MonitorizacaoOceanica\AnalysisService\bin\Debug\net8.0\AnalysisService.exe",
            UseShellExecute = true
        });
